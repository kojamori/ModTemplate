...
- copyrightHolder: defaults to the authorName if not specified
...
- discordLink: defaults to nothing and deletes the section
- readMeDescription: defaults to modDescription
